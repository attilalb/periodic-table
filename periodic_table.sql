...
--
-- Name: elements unique_names; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties elements_ref; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT elements_ref FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties types_ref; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT types_ref FOREIGN KEY (type_id) REFERENCES public.types(type_id);
